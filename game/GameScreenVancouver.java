...
public class GameScreenVancouver implements Screen {
    ...
    Vector3 touchPos;
    Array<Rectangle> items3;
    Rectangle pupa;
    int itemCount;
    static int levelStage;


    public GameScreenVancouver (final ITSchoolMeaning gam){
        this.game = gam;
        ...
        items3 = new Array<Rectangle>();
        spawnItems3();
    }

    private void spawnItems3(){
    ...
    public void render(float delta) {
        ...
        Iterator<Rectangle> iter = items3.iterator();
        while (iter.hasNext()) {
            Rectangle itemR3 = iter.next();
            if (itemR3.overlaps(pupa)) {
                itemf.play();
                itemCount++;
                iter.remove();
            }
